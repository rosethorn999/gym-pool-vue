<template>
  <div vue-spinner v-if="active">
    ...
    >
      <g>
        <rect x="49" y="67" style="fill:#FFFFFF;" width="52" height="16" />
      </g>
      <g>
        <path
          style="fill:#FFFFFF;"
      ...
      <g>
        <g>
          <path
            style="fill:#FFFFFF;"
            d="M125,122V28c0-2.2,1.8-4,4-4h7c2.2,0,4,1.8,4,4v94c0,2.2-1.8,4-4,4h-7C126.8,126,125,124.2,125,122
                   z"
          />
        </g>
        <g>
          <path
            style="fill:#FFFFFF;"
            d="M100.5,132V18c0-2.2,1.8-4,4-4h7c2.2,0,4,1.8,4,4v114c0,2.2-1.8,4-4,4h-7
                   C102.3,136,100.5,134.2,100.5,132z"
          />
        </g>
      </g>
    </svg>
...
export default {
  ...
  async created() {
    events.$on("spinner", this.trigger);
  },
  methods: {
    trigger(options) {
...
div[vue-spinner] {
  ...
  left: 0;
  right: 0;
  animation: rotate1 1.5s ease 0s infinite;
}
